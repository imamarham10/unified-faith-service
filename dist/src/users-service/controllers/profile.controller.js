...
let ProfileController = class ProfileController {
    ...
    async createProfile(user, updateProfileDto) {
    ...
    async createProfileForUser(userId, updateProfileDto) {
        try {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProfileController.prototype, "createProfileForUser", null);
exports.ProfileController = ProfileController = __decorate([
    (0, common_1.Controller)('users/profile'),
