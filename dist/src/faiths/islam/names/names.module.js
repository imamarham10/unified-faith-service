...
const names_controller_1 = require("./controllers/names.controller");
...
exports.NamesModule = NamesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [names_service_1.NamesService, prisma_service_1.PrismaService],
        exports: [names_service_1.NamesService],
    })
], NamesModule);
